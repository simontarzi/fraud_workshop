...
= Run this to prepare the full workshop
MAPBOX_TOKEN=pk.eyJ1Ijoic2ltb250YXJ6aSIsImEiOiJjbGRibHZ6aGowMXZ5M3ZvNXM3a3ZqNXJqIn0.d9F4TuGY5pyMuLUvDk1G8g /tmp/resources/reset-to-lab.sh fraud 99
